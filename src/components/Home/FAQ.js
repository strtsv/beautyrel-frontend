          ...
          <div className="row row-md-80 row-sm-50">
            <div className="col-sm-12 col-lg-4">
              <div className="subtitle">
                Frequently Asked <br className="br-none" />
                Questions
              </div>
            </div>
                ...
                <article className="card card-custom card-group-custom card-corporate">
                  <div className="card-heading" role="tab">
                    <div className="card-title">
                      <a
                        className="collapsed"
                        id="accordion1-card-head-scxqajyi"
                        data-toggle="collapse"
                        data-parent="#accordion1"
                        href="#accordion1-card-body-fiucadpr"
                        aria-controls="accordion1-card-body-fiucadpr"
                        aria-expanded="false"
                        role="button"
                      >
                  ...
                  <div
                    ...
                    id="accordion1-card-body-fiucadpr"
                    aria-labelledby="accordion1-card-head-scxqajyi"
                    data-parent="#accordion1"
                    role="tabpanel"
                  >
                ...
                <article className="card card-custom card-group-custom card-corporate">
                  <div className="card-heading" role="tab">
                    <div className="card-title">
                      <a
                        className="collapsed"
                        id="accordion1-card-head-lhyfsgto"
                        data-toggle="collapse"
                        data-parent="#accordion1"
                        href="#accordion1-card-body-cuweomyl"
                        aria-controls="accordion1-card-body-cuweomyl"
                        aria-expanded="false"
                        role="button"
                      >
                  ...
                  <div
                    className="card-collapse collapse"
                    id="accordion1-card-body-cuweomyl"
                    aria-labelledby="accordion1-card-head-lhyfsgto"
                    data-parent="#accordion1"
                    role="tabpanel"
                  >
                    <div className="card-body">
                ...
                <article className="card card-custom card-group-custom card-corporate">
                  <div className="card-heading" role="tab">
                    <div className="card-title">
                      <a
                        className="collapsed"
                        id="accordion1-card-head-pektlydn"
                        data-toggle="collapse"
                        data-parent="#accordion1"
                        href="#accordion1-card-body-nmbkplic"
                        aria-controls="accordion1-card-body-nmbkplic"
                        aria-expanded="false"
                        role="button"
                      >
                  ...
                  <div
                    className="card-collapse collapse"
                    id="accordion1-card-body-nmbkplic"
                    aria-labelledby="accordion1-card-head-pektlydn"
                    data-parent="#accordion1"
                    role="tabpanel"
                  >
                    <div className="card-body">
                ...
                <article className="card card-custom card-group-custom card-corporate">
                  <div className="card-heading" role="tab">
                    <div className="card-title">
                      <a
                        className="collapsed"
                        id="accordion1-card-head-ulgwsbdb"
                        data-toggle="collapse"
                        data-parent="#accordion1"
                        href="#accordion1-card-body-uktoaeet"
                        aria-controls="accordion1-card-body-uktoaeet"
                        aria-expanded="false"
                        role="button"
                      >
                  ...
                  <div
                    className="card-collapse collapse"
                    id="accordion1-card-body-uktoaeet"
                    aria-labelledby="accordion1-card-head-ulgwsbdb"
                    data-parent="#accordion1"
                    role="tabpanel"
                  >
                    <div className="card-body">
                ...
                <article className="card card-custom card-group-custom card-corporate">
                  <div className="card-heading" role="tab">
                    <div className="card-title">
                      <a
                        className="collapsed"
                        id="accordion1-card-head-ahsbcrxn"
                        data-toggle="collapse"
                        data-parent="#accordion1"
                        href="#accordion1-card-body-mxjgdwwh"
                        aria-controls="accordion1-card-body-mxjgdwwh"
                        aria-expanded="false"
                        role="button"
                      >
                  ...
                  <div
                    className="card-collapse collapse"
                    id="accordion1-card-body-mxjgdwwh"
                    aria-labelledby="accordion1-card-head-ahsbcrxn"
                    data-parent="#accordion1"
                    role="tabpanel"
                  >
                    <div className="card-body">
                      <p>
                        You may build a website using the template in any way
                        you like. You may not resell or redistribute templates
                        (like we do); claim intellectual or exclusive ownership
                        to any of our products, modified or unmodified. All
                        products are property of content providing companies and
                        individuals. You are also not allowed to make more than
                        one project using the same template (you have to
                        purchase the same template once more in order to make
